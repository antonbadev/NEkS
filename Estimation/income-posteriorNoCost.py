...
Bayesian estimation No Cost (psi=0) scenario
Input files:
    estimation_top8_100plus.data (high schools enrolled 100+ students)
    income-parameterSetupNoCost.csv
Output files:
    income-posteriorNoCost.csv
...
def main():
    ...
    ## Parameter setup.
    theta_setup = pd.read_csv('priors/income-parameterSetupNoCost.csv')
