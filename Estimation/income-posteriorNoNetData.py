...
Bayesian estimation absent network data (only aggregate PE) scenario
Input files:
    estimation_top8_100plus.data (high schools enrolled 100+ students)
    income-parameterSetupNoNetData.csv
Output files:
    income-posteriorNoNetData.csv
...
def main():
    ...
    ## Parameter setup.
    theta_setup = pd.read_csv('priors/income-parameterSetupNoNetData.csv')
