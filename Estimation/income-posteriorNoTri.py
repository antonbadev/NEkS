...
Bayesian estimation absent common friends term (q=0) scenario
Input files:
    estimation_top8_100plus.data (high schools enrolled 100+ students)
    income-parameterSetupNoTri.csv
Output files:
    income-posteriorNoTri.csv
...
def main():
    ...
    ## Parameter setup.
    theta_setup = pd.read_csv('priors/income-parameterSetupNoTri.csv')
